...
public class ImageUtils
{
    ...
    {
        return createHeadlessSmoothBufferedImage(image, type, width, height);
    }

    public static String[] readImages(String data)
    {
        return data.split(";");
    }

    public static BufferedImage resizeMaxValueImage(BufferedImage image, int type, int maxWidth, int maxHeight)
    {
